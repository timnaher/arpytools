...
# %%
sim_eps0_1 = PhaseSimulator(eps=0,niter=1000,oscillation_freq=100,PROP_LENGTH=500,random_start=True,k=10)
...
sim_eps0_1 = PhaseSimulator(eps=0,niter=1000,oscillation_freq=100,PROP_LENGTH=500,random_start=True,k=0)
sim_eps0_1.experiment()
